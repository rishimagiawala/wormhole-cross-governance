    ...
    <nav class="border-gray-200 px-2 sm:px-4 py-2.5 bg-gray-900">
      <div class="flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class=" w-full md:block md:w-auto" id="navbar-default">
          <ul class="flex flex-col p-4 mt-4 bg-gray-50 border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="#" class="text-white text-base block py-2 pr-4 pl-3 text-gray rounded">Home</a>
            </li>
            <li>
              <a href="#" class="text-white text-base block py-2 pr-4 pl-3  rounded">About</a>
            </li>
            <li>
              <a href="#" class="text-white text-base block py-2 pr-4 pl-3  rounded">Discord</a>
            </li>
            <li>
